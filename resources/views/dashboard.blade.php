...
<head>
    ...
    <link rel="preload" href="./assets/css/29e79c76a20ef551.css" as="style" />
    <link rel="stylesheet" href="./assets/css/29e79c76a20ef551.css" data-n-g="" /><noscript data-n-css=""></noscript>
...
<body>
    <div id="__next">
        ...
        <div class="overflow-hidden w-full h-full relative flex">
            <div class="dark hidden bg-gray-900 md:flex md:w-[260px] md:flex-col">
                <div class="flex h-full min-h-0 flex-col ">
                    <div class="scrollbar-trigger flex h-full w-full flex-1 items-start border-white/20">
                        <nav class="flex h-full flex-1 flex-col space-y-1 p-2"><a class="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-sm mb-2 flex-shrink-0 border border-white/20"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>New chat</a>
                            <div
                                class="flex-col flex-1 overflow-y-auto border-b border-white/20">
                                <div class="flex flex-col gap-2 text-gray-100 text-sm"></div>
                                <x-dropdown-link  class="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-sm" href="{{ route('profile.show') }}">
                                    {{ __('Profile') }}
                                </x-dropdown-link>
                                {{-- <a
                                href="{{ route('profile.show') }}
                                class="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-sm">  {{ __('Profile') }}</a> --}}
                               
                                <form method="POST" action="{{ route('logout') }}" >
                                    @csrf
    
                                   <x-dropdown-link class="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-sm" >
    ...
    <script id="__NEXT_DATA__" type="application/json">
        {
            "props": {
                "pageProps": {
                    "user": {
                        "id": "user-sXP7YFTOy3wO9tssAwMpRUxH",
                        "name": "sanaullah khan",
                        "email": "sanaullah2209f@aptechgdn.net",
                        "image": "https://lh3.googleusercontent.com/a/AGNmyxY8rVqmC2Jk6fMY76qZam91xrxGuUZPkAhGp9_-=s96-c",
                        "picture": "https://lh3.googleusercontent.com/a/AGNmyxY8rVqmC2Jk6fMY76qZam91xrxGuUZPkAhGp9_-=s96-c",
                        "mfa": false,
                        "groups": [],
                        "intercom_hash": "95dbb5559e1d3d6a36d29fa10ca6dfeea8bcad6ffd4ca68270b8824d231c284c"
                    },
                    "serviceStatus": {},
                    "userCountry": "PK",
                    "geoOk": true,

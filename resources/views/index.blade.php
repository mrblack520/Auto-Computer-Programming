...
var shaderMaterial = new THREE.ShaderMaterial({
  uniforms: {
    color: { value: new THREE.Color(0x72bcd4) },
    size: { value: 2.0 }
  },
  vertexShader: `
...
gsap.to(animProps, {
  ...
  onUpdate: function () {
                   ...
                   @else                        
                                        ...
                                        <div class="modal fade bg-dark opacity-75 " id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                                            <div class="modal-dialog   modal-dialog-centered ">
                                              <div class="modal-content border border1  border-4 border-success  bg-transparent">
                                          ...
                                          <div class="modal fade    bg-dark opacity-75" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content border border1  border-4 border-success  bg-transparent">
                                                <div class="modal-header   border  border-success">
        ...
        <x-button class="tg-border-btn center" ><i class="fa-solid fa-right-to-bracket" style="color: #ffffff;"></i>
            {{ __('Log in') }}
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <p >Already have account? <a  data-bs-target="#exampleModalToggle" data-bs-toggle="modal" data-bs-dismiss="modal" href="#exampleModalToggle"> Login</a></p>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                        ...
                        <div class="tgmobile__menu">
                            <nav class="tgmobile__menu-box">
                                ...
                                <div class="social-links">
                                    <ul class="list-wrap">
                                        <li><a href="https://www.facebook.com/profile.php?id=100090833048696"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="http://www.dorld.tech/"><i class="fa-solid fa-earth-europe" style="color: #ffffff;"></i></a></li>
                                        <li><a href="https://www.instagram.com/d_orld20/"><i class="fab fa-instagram"></i></a></li>
                                        <li><a href="https://www.linkedin.com/company/dorld/"><i class="fab fa-linkedin-in"></i></a></li>
    ...
    <main class="main--area">
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-xxl-6 col-xl-5 col-lg-6">
                                <div class="slider__img text-center">
                                    <img src="./assets/video/0001-0120-unscreen.gif" class="wt" data-magnetic alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row ">
                    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                       <h1 class="h1">ABOUT US</h1>
                        ...
                        <p class="tg__animate-text style col-12">At SNAS, we believe that programming should be accessible to all, regardless of their background or experience. That's why we've created an intuitive platform that enables you to write code using natural language, so that you don't have to spend hours learning complicated syntax. We're proud to have helped thousands of businesses and individuals automate their programming tasks, saving them time and money. Whether you're a beginner or an experienced programmer, SANAS has everything you need to take your coding to the next level.</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-10">
                            <div class="contact__content">
                                ...
                                <p>If you have any questions or feedback about our platform, please don't hesitate to get in touch with us. We're always happy to hear from our users and to help with any issues you might be experiencing.                       </p>
        ...
        <!-- team-area -->
        <section id="group" class="team__area team-bg section-pt-130 section-pb-100" data-background="assets/img/bg/team_bg.jpg">
            <div class="container">
                <div class="row justify-content-center">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="team__item">
                            <div class="team__thumb">
                                <a href="https://mrblack520.github.io/blackinfo.github.io/"><img src="assets/img/team/team02.png" alt="img"></a>
                            </div>
                            <div class="team__content">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="footer-text">
                                ...
                                <div class="footer-social">
                                    <a href="http://www.dorld.tech/"><img width="500px" src="assets/img/icons/Artboard 5 copy-8.png"  alt="icon"></a>
                                    <a href="https://www.linkedin.com/company/dorld/"><img src="assets/img/team/317750_linkedin_icon.png" alt="iocn"></a>
                                    <a href="https://www.instagram.com/d_orld20/"><img src="assets/img/icons/social_icon03.png" alt="iocn"></a>
                                    <a href="https://www.facebook.com/profile.php?id=100090833048696"><img src="assets/img/icons/logo-facebookpng-32221.png" alt="iocn"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="footer-newsletter">
                                ...
                                <form action="#" class="footer-newsletter-form">
                                    ...
                                    <button type="submit"><i class="fa-solid fa-location-arrow" style="color: #ffffff;"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>

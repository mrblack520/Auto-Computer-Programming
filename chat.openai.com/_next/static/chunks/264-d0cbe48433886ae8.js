                    ...
                    return e.setAccessToken = function(e) {
                        ...
                        return (0, o.Z)(function() {
                            ...
                            return (0, h.__generator)(this, function(h) {
                                switch (h.label) {
                                    case 0:
                                        return [4, fetch(e, o = (0, i.Z)({
                                            credentials: "include"
                                        }, t))];
                                    case 1:
                                        if ((a = h.sent()).status >= 500) throw n.intercomEventOnError && (0, f.LJ)(n.intercomEventOnError, {
                                            url: e,
                                    ...
                                    case 7:
                                        return h.sent(), [2, r.fetch(e, o, (0, s.Z)((0, i.Z)({}, n), {
                                            isRetry: !0
                                        }))];
                                    case 8:
                                        return [3, 10];
                                    ...
                                    case 11:
                                        if (null == c ? void 0 : c.type) throw n.intercomEventOnError && (0, f.LJ)(n.intercomEventOnError, {
                                            url: e,
                                            status: a.status.toString(),
                        ...
                        var r = new FormData;
                        return t && r.append("conversation_id", t), r.append("model", n), r.append("parent_message_id", e), r.append("file", o), this.fetch("".concat(g, "/conversation/upload"), {
                            method: "POST",
                        ...
                        return o && r.set("order", "updated"), this.fetch("".concat(g, "/conversations?").concat(r), {
                            method: "GET",
                            headers: (0, i.Z)({
                                "Content-Type": "application/json"
                        ...
                        return (0, o.Z)(function() {
                            ...
                            return (0, h.__generator)(this, function(d) {
                                return r = new AbortController, s = {
                                ...
                                }, c = "".concat("https://chat.openai.com/backend-api", "/conversation"), (0, u.L)(c, {
                                    method: "POST",
                                    credentials: "include",
                                    headers: (0, i.Z)({
                                        "Content-Type": "application/json"
                                            ...
                                            return (0, h.__generator)(this, function(r) {
                                                switch (r.label) {
                                                    case 0:
                                                        ...
                                                        return [4, e.json()];
                                                    case 1:
                                                        if (n = r.sent(), console.error(n), o = (null == n ? void 0 : n.error) || (null == n ? void 0 : n.detail)) {
                                    ...
                                    onerror: function(e) {
                                        throw "Failed to fetch" === e.message && (e = new l.kb("An error occurred. Either the engine you requested does not exist or there was another issue processing your request. If this issue persists please contact us through our help center at help.openai.com.")), (0, f.LJ)("fetch-error:conversation:new-message", {
                                            url: c,
                    ...
                    ! function() {
                        ...
                        if ("function" == typeof t) t("reattach_activator"), t("update", e.intercomSettings);
                            ...
                            var a = function() {
                                ...
                                t.type = "text/javascript", t.async = !0, t.src = "https://widget.intercom.io/widget/".concat(r);
